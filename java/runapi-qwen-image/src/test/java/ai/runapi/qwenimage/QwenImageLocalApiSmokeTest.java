...
import ai.runapi.qwenimage.types.TextToImageResponse;
    ...
    class QwenImageLocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/qwen_image/text_to_image", this::handleRequest);
        server.start();
      }
      ...
      void runUsesApacheTransportAgainstLocalApi() throws Exception {
        try (QwenImageClient client =
            QwenImageClient.builder()
                .apiKey("sk-test")
      ...
      CompletedTextToImageResponse response =
        ...
        assertEquals("/api/v1/qwen_image/text_to_image", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/qwen_image/text_to_image/task_local_123", captured.path);
