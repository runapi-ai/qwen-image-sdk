...
```shell
runapi qwen-image <operation> --async --input-file request.json > task.json
...
```shell
runapi wait "$task_id" --service qwen-image --action <operation> > result.json
```
...
- SDK integration: https://github.com/runapi-ai/qwen-image-sdk

## Variants
- `qwen-image-edit-image`: https://runapi.ai/models/qwen-image/edit-image.md
- `qwen-image-remix-image`: https://runapi.ai/models/qwen-image/remix-image.md
- `qwen-image-text-to-image`: https://runapi.ai/models/qwen-image/text-to-image.md
